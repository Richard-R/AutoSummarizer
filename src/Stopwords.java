...
public class Stopwords {
    public static final String[] stopWordsofwordnet = {
    ...
    public static Set<String> set = new HashSet<>(Arrays.asList(stopWordsofwordnet));
    ...
    public static String[] buildSortedArray(String sentence){
        ...
        String[] toReturn = new String[wordsList.size()];
        for (int i = 0; i < wordsList.size(); i++) {
            toReturn[i] = wordsList.get(i);
        }
